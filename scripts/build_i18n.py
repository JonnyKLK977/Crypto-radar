...
MANUAL_OVERRIDES = {
    "en": {
        ...
        "Chiaro": "Light",
        "Sistema": "System",
        "Tema dell'interfaccia": "Interface theme",
        "Contenuti": "Content",
        "Quantità di contenuti": "Amount of content",
        "Completa": "Full",
        "Mostra approfondimenti": "Show more detail",
        "Riduci informazioni": "Show less",
        "Passa alla vista completa": "Switch to full view",
        "Passa alla vista essenziale": "Switch to essential view",
        "Vista completa attiva": "Full view active",
        "Vista essenziale attiva": "Essential view active",
        "Torna alla Panoramica": "Return to Overview",
        "Tema aggiornato": "Theme updated",
        "Tipo di grafico": "Chart type",
        "Candele aggregate dai punti di mercato": "Candles aggregated from market data points",
        "1 ora": "1 hour",
        "2 ore": "2 hours",
        "4 ore": "4 hours",
        ...
        "Come leggere Esposizioni": "How to read Exposures",
        "Dove si concentra davvero il portafoglio": "Where the portfolio is really concentrated",
        "Reti e piattaforme comuni": "Shared networks and platforms",
        "Temi e settori ripetuti": "Repeated themes and sectors",
        "Cosa approfondire": "What to investigate",
        "Rete propria": "Native network",
        "Controllo": "Check",
        "Nessuna concentrazione evidente": "No evident concentration",
        "Valore analizzato": "Value analyzed",
        "Posizioni attive": "Active positions",
        "Copertura dati": "Data coverage",
        "Gruppo principale": "Largest group",
        "MENU MODULARE": "MODULAR MENU",
        "Le tue sezioni": "Your sections",
        "Personalizza": "Customize",
        "PERSONALIZZA MENU": "CUSTOMIZE MENU",
        "Scegli cosa vedere": "Choose what to show",
        "Chiudi personalizzazione": "Close customization",
        "Densità del menu": "Menu density",
        "Densità": "Density",
        "Comoda": "Comfortable",
        "Compatta": "Compact",
        "Ripristina": "Reset",
        "Salvato in questo browser": "Saved in this browser",
        "Mercato": "Market",
        "Contesto e ricerca": "Context and research",
        "Portafoglio e piano": "Portfolio and plan",
        "Gestione personale": "Personal management",
        "Strumenti": "Tools",
        "Analisi e controllo": "Analysis and control",
        "Community e fonti": "Community and sources",
        "Confronto e conoscenza": "Discussion and knowledge",
        "Sempre visibile": "Always visible",
        "Modalità avanzata": "Advanced mode",
        "Configurazione aggiornata": "Configuration updated",
    ...
    "es": {
        ...
        "Chiaro": "Claro",
        "Sistema": "Sistema",
        "Tema dell'interfaccia": "Tema de la interfaz",
        "Contenuti": "Contenido",
        "Quantità di contenuti": "Cantidad de contenido",
        "Completa": "Completa",
        "Mostra approfondimenti": "Mostrar más detalles",
        "Riduci informazioni": "Mostrar menos",
        "Passa alla vista completa": "Cambiar a vista completa",
        "Passa alla vista essenziale": "Cambiar a vista esencial",
        "Vista completa attiva": "Vista completa activa",
        "Vista essenziale attiva": "Vista esencial activa",
        "Torna alla Panoramica": "Volver al Resumen",
        "Tema aggiornato": "Tema actualizado",
        "Tipo di grafico": "Tipo de gráfico",
        "Candele aggregate dai punti di mercato": "Velas agregadas a partir de datos de mercado",
        "1 ora": "1 hora",
        "2 ore": "2 horas",
        "4 ore": "4 horas",
        ...
        "Come leggere Esposizioni": "Cómo leer Exposiciones",
        "Dove si concentra davvero il portafoglio": "Dónde se concentra realmente la cartera",
        "Reti e piattaforme comuni": "Redes y plataformas compartidas",
        "Temi e settori ripetuti": "Temas y sectores repetidos",
        "Cosa approfondire": "Qué investigar",
        "Rete propria": "Red propia",
        "Controllo": "Control",
        "Nessuna concentrazione evidente": "Sin concentración evidente",
        "Valore analizzato": "Valor analizado",
        "Posizioni attive": "Posiciones activas",
        "Copertura dati": "Cobertura de datos",
        "Gruppo principale": "Grupo principal",
        "MENU MODULARE": "MENÚ MODULAR",
        "Le tue sezioni": "Tus secciones",
        "Personalizza": "Personalizar",
        "PERSONALIZZA MENU": "PERSONALIZAR MENÚ",
        "Scegli cosa vedere": "Elige qué mostrar",
        "Chiudi personalizzazione": "Cerrar personalización",
        "Densità del menu": "Densidad del menú",
        "Densità": "Densidad",
        "Comoda": "Cómoda",
        "Compatta": "Compacta",
        "Ripristina": "Restablecer",
        "Salvato in questo browser": "Guardado en este navegador",
        "Mercato": "Mercado",
        "Contesto e ricerca": "Contexto e investigación",
        "Portafoglio e piano": "Cartera y plan",
        "Gestione personale": "Gestión personal",
        "Strumenti": "Herramientas",
        "Analisi e controllo": "Análisis y control",
        "Community e fonti": "Comunidad y fuentes",
        "Confronto e conoscenza": "Debate y conocimiento",
        "Sempre visibile": "Siempre visible",
        "Modalità avanzata": "Modo avanzado",
        "Configurazione aggiornata": "Configuración actualizada",
