...
async function loadAll(showFlash=false){
  try{
    ...
    renderOverview(); renderScreener(); renderPortfolio(); renderPlan(); renderDecisionLab(); renderDiscovery(); renderDemoMode(); loadImportHistory();
    loadTranslations();
